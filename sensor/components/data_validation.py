...
class DataValidation:
    ...
    def drop_missing_values_columns(self,df:pd.DataFrame,report_key_name:str)->Optional[pd.DataFrame]:
        """
        This function will drop columns which contain missing values more that specified threshold

        df:Accepts a pandas as dataframe
        threshold: percentage criteria to drop a column
        =============================================================================
        returns Pandas DataFrame if atleast a single column is available after missing columns drop else returns null
        ...
        try:
            ...
            #Selecting columns names which contains null values
            logging.info(f"Selecting columns names which contains null values above to {threshold}")
    ...
    def initiate_data_validation(self)->artifact_entity.DataValidationArtifact:
        try:
            ...
            logging.info(f"Dropping null values from base df")
            ...
            # Same for training and testing df
            ...
            if train_df_columns_status:
                logging.info(f"As all columns are available in train df detecting data drift")
                self.data_drift(base_df=base_df, current_df=train_df,report_key_name="data_drift_within_train_dataset")

            if test_df_columns_status:
                logging.info(f"Als all columns are available in test df detecting data drift")
